...
-- split-monitor-workspaces: per-monitor workspace numbering + link_monitors for simultaneous switching
...
-- Monitor profiles managed by hyprmon: run `hyprmon`, create work/home profiles
-- hyprmon saves to ~/.config/hypr/monitors.conf (non-symlink, avoids write issues)
-- Profiles:
...
hl.config({
    general = {
        ...
        col = {
            ...
            active_border   = { colors = {"rgba(bb9af7ee)", "rgba(f4effdee)", "rgba(bb9af7ee)", "rgba(f4effdee)", "rgba(bb9af7ee)"}, angle = 0 },
            inactive_border = { colors = {"rgba(bb9af7ee)", "rgba(f4effdee)", "rgba(bb9af7ee)", "rgba(f4effdee)", "rgba(bb9af7ee)"}, angle = 0 },
        },
...
-- Switch workspaces with mainMod + [1-9] — all monitors switch simultaneously (link_monitors)
...
-- hl.bind(mainMod .. " + S", hl.dsp.workspace.toggle_special("magic"))  -- removed, S = exit session
